...
namespace SNMP.ENTITY.Events.DeviceParameter
{
    ...
    {
        public DeviceParameterCreatedEvent(int deviceId, int deviceParameterId, int parameterId, bool ısEnable, int pollingIntervalSeconds, double? minThreshold, double? maxThreshold)
        {
            DeviceId = deviceId;
