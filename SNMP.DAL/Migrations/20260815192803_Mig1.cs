        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AuthProtocol = table.Column<int>(type: "integer", nullable: true),
                    AuthPassword = table.Column<string>(type: "text", nullable: true),
                    PrivacyProtocol = table.Column<int>(type: "integer", nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2026, 8, 12, 0, 0, 0, 0, DateTimeKind.Utc), true, "Admin", null },
                    { 2, new DateTime(2026, 8, 12, 0, 0, 0, 0, DateTimeKind.Utc), true, "User", null }
                });
